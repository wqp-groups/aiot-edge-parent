...
//    private String uploadDirectory;
    ...
    @Bean
    public AiotEdgeSenseConfigEntity aiotEdgeSenseConfig(){
...
//        File confFile = new File(os_name.contains("Windows") ? aiotEdgeSenseConfigWindows : aiotEdgeSenseConfigLinux);
        ...
        AiotEdgeSenseConfigEntity aiotEdgeSenseConfigEntity = JacksonMapperUtil.json2object(confFile, new TypeReference<AiotEdgeSenseConfigEntity>(){});
        ...
        if(aiotEdgeSenseConfigEntity.getNetty() == null) aiotEdgeSenseConfigEntity.setNetty(new AiotEdgeSenseConfigEntity.Netty());
